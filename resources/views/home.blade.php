          ...
          <div class="px-6 pt-6 lg:max-w-2xl lg:pr-0 lg:pl-8">
            ...
            >
              ...
              <div class="hidden lg:ml-12 lg:flex lg:gap-x-14">
                <a href="#projects" class="text-sm/6 font-semibold text-gray-900"
                  >Projects</a
                >
                <a href="#skills" class="text-sm/6 font-semibold text-gray-900"
                  >Skills</a
                >
                <a href="#experience" class="text-sm/6 font-semibold text-gray-900"
                  >Experience</a
                >
            ...
            <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                <div class="hidden sm:mb-10 sm:flex">
                  ...
                  >
                    Building scalable web solutions for real estate, education, finance, and logistics.
                    <a
                ...
                >
                  Full-stack web developer skilled in PHP, JavaScript, React, and MySQL. Passionate about crafting user-friendly, efficient, and innovative digital solutions for diverse industries.
                </p>
                <div class="mt-10 flex items-center gap-x-6">
                  <a
                    ...
                    >Explore Portfolio</a
                  >
                  <a href="https://linkedin.com/in/lethinh73" class="text-sm/6 font-semibold text-gray-900"
                    >Connect with me <span aria-hidden="true">→</span></a
                  >
                </div>
              </div>
            </div>
