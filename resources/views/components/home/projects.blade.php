<div class="bg-gray-200 dark:bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div class="mx-auto max-w-2xl">
            <h2 class="text-4xl font-semibold tracking-tight text-balance text-black dark:text-white sm:text-5xl">Meet our team</h2>
        ...
        <ul role="list"
            ...
            <li class="rounded-2xl bg-gray-400 dark:bg-gray-800 px-8 py-10">
                <img class="mx-auto size-48 rounded-full md:size-56"
                    ...
                    alt="" />
                <h3 class="mt-6 text-base/7 font-semibold tracking-tight text-black dark:text-white">Leonard Krasner</h3>
                <p class="text-sm/6 text-gray-800 dark:text-gray-400">Senior Designer</p>
                <ul role="list" class="mt-6 flex justify-center gap-x-6">
                    <li>
                        <a href="#" class="text-gray-800 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300">
