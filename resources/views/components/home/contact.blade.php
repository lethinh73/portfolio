<div class="relative isolate bg-gray-200 dark:bg-gray-900 py-5 border-y-1 border-gray-400 dark:border-gray-800" id="contact">
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div class="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
            <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                ...
                <h2 class="text-4xl font-semibold tracking-tight text-pretty text-black dark:text-white sm:text-5xl">Get in touch
                </h2>
                ...
                <dl class="mt-10 space-y-4 text-base/7 text-gray-600 dark:text-gray-300">
                    <div class="flex gap-x-4">
                        <dt class="flex-none">
                            ...
                            <svg class="h-7 w-6 text-gray-800 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <dd>
                            <a class="hover:text-black dark:hover:text-white" href="tel:+1-713-815-0775">(713) 815-0775</a>
                        </dd>
                    </div>
                    <div class="flex gap-x-4">
                        <dt class="flex-none">
                        ...
                        <dd>
                            <a class="hover:text-black dark:hover:text-white" href="mailto:lethinh73@gmail.com">lethinh73@gmail.com</a>
                        </dd>
                    </div>
                </dl>
            </div>
        </div>
        <form action="#" method="POST" class="px-6 pt-20 pb-24 sm:pb-32 lg:px-8 lg:py-48 border-l-1 border-gray-400 dark:border-gray-800">
            <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    <div>
                        <flux:input label="First name" type="text" placeholder="John" />
                    </div>
                    <div>
                        <flux:input label="Last name" type="text" placeholder="Doe" />
                    </div>
                    <div class="sm:col-span-2">
                        <flux:input label="Email" type="email" placeholder="example@email.com" />
                    </div>
                    <div class="sm:col-span-2">
                        <flux:input label="Phone number" type="phone" placeholder="(555) 555-5555" mask="(999) 999-9999" />
                    </div>
                    <div class="sm:col-span-2">
                        <flux:textarea label="Message" placeholder="Your message" />
                    </div>
                </div>
                <div class="mt-8 flex justify-end">
                    <flux:button icon="envelope">Submit</flux:button>
                </div>
            </div>
        </form>
    </div>
