...
export const BentoCard: React.FC<{
  ...
  const baseClassName = `card flex flex-col justify-between relative rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] card--border-glow ${className}`;
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
    <>
      ...
      <div className="bento-section relative w-full max-w-full select-none" ref={gridRef}>
